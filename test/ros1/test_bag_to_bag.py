...
class TestBagInputBagOutput(unittest.TestCase):
    """
    ...
    def __init__(self, *args, **kwargs):
        super(TestBagInputBagOutput, self).__init__(*args, **kwargs)
    ...
    def setUp(self):
        ...
        self._outname = tempfile.NamedTemporaryFile(suffix=".bag").name
